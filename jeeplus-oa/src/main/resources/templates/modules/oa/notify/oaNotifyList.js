		  ...
		  //请求方法
		    ...
		    ,{
		        ...
		        formatter:function(value, row , index){
		        	return "<a href='${ctx}/oa/oaNotify/form?isSelf=${isSelf}&id="+row.id+"' data-pjax>"+value+"</a>";
		        }
		    }
		    ,{
		        field: 'type',
			...
			,{
		        ...
		        formatter:function(value, row , index){
		        	if(value == '0'){
		        		return '<font  class="jp-tag jp-tag-has-color" style="background-color: rgb(255, 85, 0);" >'+jp.getDictLabel(${fn.toJson(fn.getDictList('oa_notify_status'))}, value, "-")+'</font>';
		        	}else{
		        		return '<font  class="jp-tag jp-tag-has-color" style="background-color: rgb(135, 208, 104);">'+jp.getDictLabel(${fn.toJson(fn.getDictList('oa_notify_status'))}, value, "-")+'</font>';
			        }
		        }
		        ...
		        formatter:function(value, row , index){
					...
					<% if(isSelf){ %>
			        	if(value == '0'){
			        		return '<font color="red">'+jp.getDictLabel(${fn.toJson(fn.getDictList('oa_notify_read'))}, value, "-")+'</font>';
			        	}else{
			        		return '<font color="green">'+jp.getDictLabel(${fn.toJson(fn.getDictList('oa_notify_read'))}, value, "-")+'</font>';
			        	}
			       <% } %>
                   <% if(!isSelf){ %>
