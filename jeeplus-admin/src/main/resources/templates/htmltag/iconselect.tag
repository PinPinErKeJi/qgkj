...
<input id="${id}" name="${name}" type="hidden" value="${value!}"/><a id="${id}Button" href="javascript:" class="jp-btn jp-btn-primary">选择</a>&nbsp;&nbsp;
<input id="${id}clear" class="jp-btn" type="button" value="清除" onclick="clear()"/>
