...
$(document).ready(function () {
    ...
    $(function () {
        var set = function () {
            ...
            url = window.location,
            element = $('.sidebar-nav ul.nav a').filter(function () {
                return $(this).attr("data-index")!=undefined &&  url.href.endsWith($(this).attr("data-index"));
            }).addClass('active').parent().parent().addClass('in').prev().addClass("active").parent();
        if (element.is('li')) {
            element.addClass('active');
        }
        $('.sidebar-nav ul.nav a').click(function () {
                if($(this).hasClass('waves-effect active')!=true && $(this).parents("li.active").find("a.waves-effect").hasClass("active")!=true){
                    $('.sidebar-nav ul.nav a.active').removeClass("active");
                    if($(this).hasClass('waves-effect')){
                        $(this).addClass("active")
                    }else  if($(this).parents("li.active")){
                        $(this).parents("li.active").find("a.waves-effect").addClass("active");
                    }
                }
            var me = this;
            $('.sidebar-nav ul.nav ul.nav a').filter(function () {
                return this != me;
            }).removeClass('active');
            $(this).addClass('active');
        })
