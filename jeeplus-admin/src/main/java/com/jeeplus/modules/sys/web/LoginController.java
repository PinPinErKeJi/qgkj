...
public class LoginController extends BaseController
{
    ...
    public String index(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        {
            if(StringUtils.isBlank(ConfigUtils.getHomeUrl()) ||
                    "/".equals(ConfigUtils.getHomeUrl())){
                return "modules/sys/login/sysIndex";
            }else {
                return "redirect:" + adminPath + ConfigUtils.getHomeUrl();
            }
    ...
    public String getTabInCookie(@PathVariable
    String tab, HttpServletRequest request, HttpServletResponse response)
    {
