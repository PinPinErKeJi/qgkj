...
public class FileKit {
     ...
     * @return
     */
    public static String getRecorBaseDir(){
        String dir =  JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL  + "record/";
     ...
     * @return
     */
    public static String getRecordBaseUrl(){
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL +  "record/";
    }
     ...
     * @return
     */
    public static String getRegisterBaseDir(){
        String dir =  JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL  + "register/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    /**
     ...
     * @return
     */
    public static String getRegisterBaseUrl(){
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL +  "register/";
    }
    /**
     * 共享文档物理存储地址
     * @return
