...
$(document).ready(function() {
  ...
  function refresh() {
   ...
   //新增表单页面
 function add() {
     jp.openSaveDialog('新增富文本测试', "${ctx}/test/note/testNote/form/add",'800px', '500px');
 }
  //编辑表单页面
  function edit(id){
      if(!id){
	  ...
	  jp.openSaveDialog('编辑富文本测试', "${ctx}/test/note/testNote/form/edit?id="+id,'800px', '500px');
  }
  //查看表单页面
  function view(id) {
      if(!id){
      ...
      jp.openViewDialog('查看富文本测试', "${ctx}/test/note/testNote/form/view?id="+id,'800px', '500px');
  }
</script>