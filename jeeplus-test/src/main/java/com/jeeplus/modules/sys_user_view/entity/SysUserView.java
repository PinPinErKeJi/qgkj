 ...
 */
package com.jeeplus.modules.sys_user_view.entity;
 ...
 * @version 2019-02-16
 */
public class SysUserView extends DataEntity<SysUserView> {
	...
	@ExcelField(title="是否可登录", align=2, sort=13)
