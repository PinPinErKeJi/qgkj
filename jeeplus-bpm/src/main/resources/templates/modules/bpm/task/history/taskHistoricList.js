		  ...
		  //请求方法
		    ...
		    },
		   {
			   ...
			   formatter: function operateFormatter(value, row, index) {
                   ...
                   return [
                       '<a href="${ctx}/act/task/form?taskDefKey='+row['task.taskDefinitionKey']+'&procInsId='+row['task.processInstanceId']+'&procDefId='+row['task.processDefinitionId']+'" data-pjax>详情</a>'
              		 ].join('');
			   }else{
                   return [
                       '<a href="${ctx}/act/task/form?taskDefKey='+row['task.taskDefinitionKey']+'&procInsId='+row['task.processInstanceId']+'&procDefId='+row['task.processDefinitionId']+'" data-pjax>详情</a>',
