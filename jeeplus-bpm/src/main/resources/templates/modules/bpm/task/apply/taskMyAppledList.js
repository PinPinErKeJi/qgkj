                       ...
                       events: {
                           ...
                           formatter: function operateFormatter(value, row, index) {
                               if (row['procIns.status'].startsWith("[进行中]")) {
                                   return [
                                       '<a class="history" href="#" >进度</a>',
                                       '<div class="jp-divider jp-divider-vertical"></div>',
                                       '<a href="${ctx}/act/task/formDetail?'+'&procInsId='+row['procIns.processInstanceId']+'&procDefId='+row['procDef.processDefinitionId']+'" data-pjax>详情</a>',
                                       '<div class="jp-divider jp-divider-vertical"></div>',
